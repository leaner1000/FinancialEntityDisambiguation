...
class BertModel():
    ...
    def build_model(self):
        ...
        similarity = Lambda(lambda x:_cosine(x))([bert_out1,bert_out2])
        
        concat = Lambda(lambda x:tf.reshape(x,[-1,768*3]))(bert_out)
...
##    data=train_data_generator(seed=432)
...
##        if(acc>acc_max):
##            acc_mac=acc
##            model.model.save_weights("bert_model4_epoch"+str(i)+"acc"+str(acc))
##        else:
##            break
